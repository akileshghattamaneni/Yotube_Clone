  ...
  return (
    <div className="grid grid-flow-col p-2 m-2 items-center">
      ...
      <div className="col-span-1 flex justify-between">
        ...
        <img
          src="https://res.cloudinary.com/dd5vs48c2/image/upload/v1709803519/video_ip1npi.png"
          alt="videoLogo"
          className="h-8"
        />
        <img
          alt="noticationBellLogo"
          src="https://res.cloudinary.com/dd5vs48c2/image/upload/v1709803200/notification_cnmafv.png"
          className="h-8"
        />
        <img
          className="h-8"
          alt="userLogo"
          src="https://cdn.iconscout.com/icon/free/png-512/free-user-1648810-1401302.png?f=webp&w=512"
        />
      </div>
    </div>
  );
